...
import kotlin.math.*
internal class BaselineLineGeometry(private val checkpoint: () -> Unit = {}) {
    ...
    fun frame(original: GrayImage): GeometryFrame? {
        ...
        return GeometryFrame(grid,StructureDiagnostics(horizontalCandidateLines=horizontal.candidateCount,verticalCandidateLines=vertical.candidateCount,horizontalSelectedLines=hs.size,verticalSelectedLines=vs.size))
    }
